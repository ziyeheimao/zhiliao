...
<template>
  <div class="ctn">
    ...
    <div>
      <el-button type="primary" @click="select" size="small" icon='el-icon-picture-outline'>选取头像</el-button>
      <el-button @click="upload" type="primary" size="small" icon='el-icon-upload'>上传头像</el-button>
